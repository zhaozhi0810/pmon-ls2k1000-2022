...
/*	rxdesc_addr = (u32)(rxdesc);
	rxdesc_addr |= 0xa0000000;
	rxdesc = (DmaDesc *)(rxdesc_addr);
*/	
/* sw	
...
*/
	...
	TR("%02d %08x %08x %08x %08x,&buf:%08x %08x %08x %08x\n",rxnext,(u32)rxdesc,rxdesc->status,rxdesc->length,rxdesc->buffer1,&rxdesc->buffer1,rxdesc->buffer2,rxdesc->data1,rxdesc->data2);
#endif
	(gmacdev->BusyRxDesc)++; //One descriptor will be given to Hardware. So busy count incremented by one
	//pci_sync_cache(0, (vm_offset_t)rxdesc,64, SYNC_W);
#if SYNOP_RX_DEBUG
